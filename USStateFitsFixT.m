...
% import data
paramfits = readtable('paramfitsFixT.csv');
...
for its = 1:length(Names)
    ...
    betag=3/Tg;
    lsqwt = .05;
    lb = [2/T, 100, .001, .01, .001,0.050,0.000,1.00000,0];
    ...
    paramguess = paramfits(its,1:end-1);
...
save('paramfitsFinalFixT.mat','paramfitsFinalFixInts')
